...
class ArreglarCSV:
    ...
    def __init__(self):
        ...
        creaTablaNumericarCSV=self.invertirColumnas(EFelicidadCSV)
        ...
        claseGenerada=np.array(self.generarClase(sumaMuestras.copy(),media))
    ...
    def invertirColumnas(self,matriz):
    ...
    def generarClase(self,vector,med):    
        salida=[]
        for  x in vector:       
            if (x < med):
                salida.append(0)
